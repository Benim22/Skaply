...
export function Hero() {
  ...
  return (
    <section className="relative pt-24 pb-24 md:pt-36 md:pb-36 lg:pt-52 lg:pb-52 overflow-hidden min-h-[60vh] md:min-h-[70vh] lg:min-h-[85vh]">
      {/* Video Background */}
      ...
      <div className="container relative z-10 mx-auto px-4 h-full flex items-center">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-4 md:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#00ADB5] via-white to-[#E94560]">
